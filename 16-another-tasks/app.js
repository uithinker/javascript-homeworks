...
toDoList.addTask.apply(newTask, ['Looksmaxing', 5]);
toDoList.addTask.apply(newTask, ['Repeat EN', 10]);
toDoList.addTask.apply(newTask, ['Wash dishes', 15]);
toDoList.addTask.apply(newTask, ['Drink water', 27]);

toDoList.deleteTask.call(newTask, 1);

const updateNameOrPriority = toDoList.updateTask.bind(newTask);
updateNameOrPriority(2, 'Repeat RU', 888);

toDoList.sortTasks.call(newTask);
